...
int main()
{
    ...
    while(!CGShouldWindowClose(window))
    {
        ...
        //CGDrawText(CGSTR("test_text_2"), CGSTR("test_font"), CGConstructTextProperty(120, 120, 30, 4), prop, window);
        
        CGVisualImage* test_text_tick = CGCreateTextVisualImage(CGSTR("test_text_2"), CGSTR("test_font"), CGConstructTextProperty(120, 120, 30, 4), window);
